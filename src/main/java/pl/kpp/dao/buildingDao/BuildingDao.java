...
public class BuildingDao {
    ...
    public static Integer getMaxPosition(int floor) {
        ...
        try {
            ...
            ResultSet result = stat.executeQuery("SELECT MAX(building_x) from building WHERE building_parent="+floor);
    ...
    public static Integer getMaxPositionY(int floor) {
        ...
        try {
            Statement stat = date.getCon().createStatement();
            ResultSet result = stat.executeQuery("SELECT MAX(building_y) from building WHERE building_parent=" + floor);
